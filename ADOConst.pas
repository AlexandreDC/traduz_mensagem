...
resourcestring
  ...
  SMissingConnection = 'Faltando Connection ou ConnectionString';
  ...
  SCantRequery = 'Não pode executar um Requery depois que a conexão mudou ';
  SNoFilterOptions = 'FilterOptions não é suportado';
  SRecordsetNotOpen = 'Recordset não está aberto';
  sNameAttr = 'Nome';
  sValueAttr = 'Valor';
